  ...
  return (
    <div className="max-w-4xl mx-auto bg-surface-light dark:bg-surface-dark rounded-xl shadow-card-light dark:shadow-card-dark border border-border-light dark:border-border-dark p-4 sm:p-8 md:p-12">
      ...
      <div className="mb-5 sm:mb-8 border-b border-border-light dark:border-border-dark pb-5 sm:pb-8">
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-12 text-center">
          <div className="flex items-center gap-2 sm:gap-3">
            <span className="material-symbols-outlined text-primary text-2xl sm:text-3xl">timer</span>
            <div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <span className="material-symbols-outlined text-primary text-2xl sm:text-3xl">rule</span>
            <div>
      ...
      <div className="mb-6 sm:mb-10">
        <div className="text-center mb-5 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-text-light dark:text-text-dark mb-1">Subject Specific Instructions</h2>
          <p className="text-xs sm:text-sm font-semibold text-primary uppercase tracking-wider">Physics / Chemistry / Mathematics</p>
        </div>
        <div className="mb-5 sm:mb-8 p-4 sm:p-6 rounded-xl border border-blue-100 dark:border-blue-900/30 bg-blue-50/50 dark:bg-blue-900/10">
          <h3 className="text-base sm:text-lg font-bold text-text-light dark:text-text-dark mb-3 sm:mb-4 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-primary"></span>
            SECTION A <span className="text-text-secondary-light dark:text-text-secondary-dark font-normal text-xs sm:text-base ml-1">(Maximum Marks: 80)</span>
          </h3>
          <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-text-secondary-light dark:text-text-secondary-dark list-disc list-outside ml-4 mb-4 sm:mb-6 leading-relaxed">
          ...
          <div className="overflow-x-auto rounded-lg border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark">
            <table className="min-w-full divide-y divide-border-light dark:divide-border-dark text-xs sm:text-sm">
              <thead className="bg-gray-50 dark:bg-zinc-800/50">
                <tr>
                  <th className="px-2.5 sm:px-4 py-2 sm:py-3 text-left font-semibold text-text-light dark:text-text-dark w-1/3">Result</th>
                  <th className="px-2.5 sm:px-4 py-2 sm:py-3 text-center font-semibold text-text-light dark:text-text-dark w-16 sm:w-24">Marks</th>
                  <th className="px-2.5 sm:px-4 py-2 sm:py-3 text-left font-semibold text-text-light dark:text-text-dark">Criteria</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border-light dark:divide-border-dark">
                <tr>
                  <td className="px-2.5 sm:px-4 py-2 sm:py-3 font-medium text-text-light dark:text-text-dark">Full Marks</td>
                  <td className="px-2.5 sm:px-4 py-2 sm:py-3 text-center text-green-600 dark:text-green-400 font-bold">+4</td>
                  <td className="px-2.5 sm:px-4 py-2 sm:py-3 text-text-secondary-light dark:text-text-secondary-dark">Correct answer</td>
                </tr>
                <tr>
                  <td className="px-2.5 sm:px-4 py-2 sm:py-3 font-medium text-text-light dark:text-text-dark">No Mark</td>
                  <td className="px-2.5 sm:px-4 py-2 sm:py-3 text-center text-text-secondary-light dark:text-text-secondary-dark">0</td>
                  <td className="px-2.5 sm:px-4 py-2 sm:py-3 text-text-secondary-light dark:text-text-secondary-dark">Unanswered / Marked for review</td>
                </tr>
                <tr>
                  <td className="px-2.5 sm:px-4 py-2 sm:py-3 font-medium text-text-light dark:text-text-dark">Minus One Mark</td>
                  <td className="px-2.5 sm:px-4 py-2 sm:py-3 text-center text-red-500 dark:text-red-400 font-bold">-1</td>
                  <td className="px-2.5 sm:px-4 py-2 sm:py-3 text-text-secondary-light dark:text-text-secondary-dark">Incorrect answer</td>
                </tr>
              </tbody>
            </table>
          </div>
        </div>
        <div className="mb-5 sm:mb-8 p-4 sm:p-6 rounded-xl border border-amber-100 dark:border-amber-900/30 bg-amber-50/50 dark:bg-amber-900/10">
          <h3 className="text-base sm:text-lg font-bold text-text-light dark:text-text-dark mb-3 sm:mb-4 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-amber-500"></span>
            SECTION B <span className="text-text-secondary-light dark:text-text-secondary-dark font-normal text-xs sm:text-base ml-1">(Maximum Marks: 20)</span>
          </h3>
          <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-text-secondary-light dark:text-text-secondary-dark list-disc list-outside ml-4 mb-4 sm:mb-6 leading-relaxed">
