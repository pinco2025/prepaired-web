...
const TestSubmitted: React.FC = () => {
  return (
    <div className="w-full max-w-lg text-center bg-surface-light/80 dark:bg-surface-dark/80 backdrop-blur-sm p-8 md:p-12 rounded-xl shadow-card-light dark:shadow-card-dark border border-border-light dark:border-border-dark">
      <div className="mb-6">
        <span className="material-icons-outlined text-green-500 text-6xl">check_circle</span>
      </div>
