                                ...
                                <div className="flex flex-col md:flex-row items-center justify-between">
                                    ...
                                    <div className="flex-1 p-8 md:p-12 z-10 flex flex-col justify-center">
                                        ...
                                        {(isPaidUser || paymentSuccess) ? (
                                            ...
                                            >
                                                <span className="relative">{paymentLoading ? 'Processing...' : 'Claim Free Bonus Now'}</span>
                                                {!paymentLoading && <span className="material-symbols-outlined transition-transform group-hover:translate-x-1 relative font-bold">arrow_forward</span>}
                                            </button>
                                        )}
                                        {paymentError && (
