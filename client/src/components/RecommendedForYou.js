    ...
    <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-xl shadow-card-light dark:shadow-card-dark">
      ...
      <div className="space-y-4">
        <div className="p-4 border border-border-light dark:border-border-dark rounded-lg">
          ...
          <a className="text-sm font-semibold text-primary hover:underline" href="#" onClick={() => console.log('Start Practice: Rotational Motion')}>Start Practice</a>
        </div>
        <div className="p-4 border border-border-light dark:border-border-dark rounded-lg">
          ...
          <a className="text-sm font-semibold text-primary hover:underline" href="#" onClick={() => console.log('Watch Video: p-Block Elements')}>Watch Now</a>
        </div>
        <div className="p-4 border border-border-light dark:border-border-dark rounded-lg">
          ...
          <a className="text-sm font-semibold text-primary hover:underline" href="#" onClick={() => console.log('Take Quiz: Calculus')}>Take Quiz</a>
        </div>
      </div>
    </div>
  );
